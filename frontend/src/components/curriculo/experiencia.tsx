export default function Experiencia() {
  return (
    <div className="flex flex-col md:flex-row lg:flex-col items-center justify-around bg-black border border-zinc-800 rounded-2xl gap-6 p-6">
...
function Item(props: { principal: string; label: string }) {
  return (
    <div className="flex flex-col items-center">
      <span className="text-red-500 text-4xl font-bold leading-6">{props.principal}</span>
